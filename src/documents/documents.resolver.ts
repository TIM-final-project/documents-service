...
export class DocumentsResolver {
    ...
    async createDocument(
        ...
        const documentSchema: DocumentSchema = await this.documentService.create(input);
    ...
    async updateDocument(
        ...
        const documentSchema: DocumentSchema = await this.documentService.update(id, input);
        return documentSchema;
    }
}
